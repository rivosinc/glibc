...
callPackage ./common.nix {inherit stdenv src version;} {
  pname = "glibc-locales";
  ...
  buildPhase =
    ''
      ...
      echo 'C.UTF-8/UTF-8 \' >> ../source/localedata/SUPPORTED

      # Hack to allow building of the locales (needed since glibc-2.12)
      sed -i -e 's,^$(rtld-prefix) $(common-objpfx)locale/localedef,localedef $(LOCALEDEF_FLAGS),' ../source/localedata/Makefile
    ''
    + lib.optionalString (!allLocales) ''
      ...
      cat ../source/localedata/SUPPORTED | grep ' \\' \
      ...
      echo SUPPORTED-LOCALES='${toString locales}' > ../source/localedata/SUPPORTED
    ''
    + ''
  ...
  installPhase = ''
    ...
    cp -v ../source/localedata/SUPPORTED "$out/share/i18n/SUPPORTED"
  '';

  setupHook =
    writeText "locales-setup-hook.sh"
    ''
