...
assert withGd -> gd != null && libpng != null;
  stdenv.mkDerivation ({
      ...
      # glibc won't build with --disable-shared
      ...
      configureFlags =
        ...
        # GCC 13 triggers new warnings with glibc builds.
        ++ lib.optional (stdenv.cc.isGNU && lib.versionAtLeast stdenv.cc.version "13.0") "--disable-werror";
      ...
      meta = with lib;
        {
          ...
          longDescription = ''            Any Unix-like operating system needs a C library: the library which
